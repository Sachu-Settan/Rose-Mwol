...
└─────────────────⸙ \n\ ______`
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://raw.githubusercontent.com/Sachu-Settan/Rose-Mwol/main/Media/Rose-Bot-Sachu-small.jpg")).buffer(), text.trim(), '© ʀᴏꜱᴇ-ᴍᴡᴏʟ ©', 'Owner Bot', ',owner', 'All Commands', '.? all', m)
  } catch (e) {
