...
`.trim()
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://github.com/neera-j/Bot-Files/blob/main/images/Rose-Mwol.jpg")).buffer(), haruno, '© ʀᴏꜱᴇ-ᴍᴡᴏʟ', 'ᴍᴇɴᴜ', '.menu', 'ᴏᴡɴᴇʀ', '.owner', m)
}
handler.tags = ['main']
handler.help = ['rules']
